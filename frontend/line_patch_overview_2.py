...
for i, line in enumerate(lines):
    if not skip:
        ...
        if '<div className="bg-card border border-white/10 p-4 sm:p-6 rounded-xl space-y-4 xl:col-span-2">' in line or '<div className="bg-card border border-white/10 p-4 sm:p-6 rounded-xl space-y-4">' in line:
