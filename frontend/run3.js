...
const replacement = `<div className="bg-black/20 p-4 sm:p-6 rounded-xl border border-cyan-400/20 space-y-4 shadow-sm">
                            ...
                            <p className="text-xs text-muted-foreground">
                                {t('在此处为各个功能项选择默认的全局 API（持久化）。如果在具体功能页面进行了选择，则优先使用该临时配置（刷新丢失）。', 'Select the default persistent global API for each function here. This will be overridden by temporary selections in specific function pages.')}
                            </p>
