...
const anchor = `                        <div className="bg-black/20 p-4 sm:p-6 rounded-xl border border-cyan-400/20 space-y-4 shadow-sm">
                            <div className="flex items-center justify-between gap-3">
                                <h3 className="text-base font-medium">{t('閫夋嫨榛樿婵€娲荤殑 API 閰嶇疆', 'Select Default Activated API Config')}</h3>`;

const block = `<div className="bg-black/20 p-4 sm:p-6 rounded-xl border border-cyan-400/20 space-y-4 shadow-sm">
                            <div className="flex items-center justify-between gap-3">
...
if (code.includes(anchor)) {
    ...
    console.log('Block cleanly restored!');
} else {
