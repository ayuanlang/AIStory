                    ...
                    return entities.map((entity, entityIndex) => {
                        ...
                        <div className="relative aspect-video w-full overflow-hidden bg-black">
                            ...
                            <div className={`absolute right-2 z-20 opacity-0 group-hover:opacity-100 transition-opacity flex gap-2 ${hasRunningSubjectImageJob ? 'top-12' : 'top-2'}`}>
                                ...
                                {entity.old_id && (
                                    <button
                                        onClick={(e) => { e.stopPropagation(); handleSyncFromOld(entity.old_id, entity.id); }}
                            ...
                            <div className="w-1/2 flex flex-col h-full bg-[#1e1e1e]">
                                ...
                                <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                                    ...
                                    <div className="flex gap-2">
                                        {viewingEntity.old_id && (
                                            <button onClick={() => handleSyncFromOld(viewingEntity.old_id, viewingEntity.id)} className="px-3 py-1.5 bg-yellow-500/20 text-yellow-300 text-xs font-bold rounded-lg border border-yellow-500/30 hover:bg-yellow-500/30 flex items-center justify-center gap-1 transition-colors">
                                                <RefreshCw size={14} />
