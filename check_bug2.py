...
from app.api.endpoints import _collect_prompt_entity_mentions
...
# monkey patch entity lookup in module scope so _collect_prompt_entity_mentions can use it?
# wait, _collect_prompt_entity_mentions has an inner scope in the real code. 
# let's just use the actual _append_video_api_ref_mapping
