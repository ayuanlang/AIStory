...
6. **品质收束（强制，每镜末尾）**：五大维度写完后，中英文视频提示词均须以独立收束句结尾；中文原文逐字为：`人物面部稳定不变形，动作自然流畅，无卡顿无闪烁，无背景音乐，无字幕，视频全程禁止出现外形、着装、配饰完全一致的人物，禁止生成同款分身、双胞胎效果，同一画面中仅保留单个对应人物，不出现人物重复复刻，高清，细节丰富，电影质感，色彩自然，光影柔和`。用 `<br>` 与上段分隔；禁止改写、删减或漏写。
