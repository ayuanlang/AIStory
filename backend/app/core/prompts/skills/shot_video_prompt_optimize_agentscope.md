...
# Prompt Updated At: 2026-08-09 17:20:00 +08:00
...
1. **Review**：通读 `# Draft Shot Table` 与可选 `# Scene Context`；逐镜检查 `Video Content (CN)` 五段完整性、ENV 标签、P1 建置可读、光影两段、品质收束原文。
...
4. **禁项清理**：Logic 散文、度数工程句、「不可见」工程句、CHAR/PROP 外形复述、表外说明。
