...
2. **运镜与动作流**（须完整呈现 Beat 完整逻辑六环节，并符合 §三.4、§五、§六、§七；**动作/道具/ENV 逐句继承见 §一.2，与 §六.1 对白同级**）：
   ...
   - **P2…Pn（环节 3–6 过程）**：运镜/动作/对白/微表演/反馈；含 `(Pn)` 时写环节 4–5；移动写轨迹节点 FG/MG/BG+左中右；**打斗/术法/轻功/空战**须 §5.5 运镜+**快慢结合**升格分工(§5.4.1)，P 段须写清常速/升格/Speed Ramp 切换；**特效攻击/投射/术法对撞**须 §5.5 A-2 快慢相位+命中升格；**追逐**须 §5.5「追逐」跟拍；**宏观**须布满画面三层阵列(§三.4)。
