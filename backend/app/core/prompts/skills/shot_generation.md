...
上游Beat切换说明中定义了6种标准过渡手法及详细的“离镜/入镜”动势描写，分镜阶段必须将其转化为具体的镜头语言并加以应用：
