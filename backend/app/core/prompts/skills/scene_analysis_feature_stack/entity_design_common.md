...
- **中文提示词维度**：连贯自然中文短句/短段。
  ...
  - 最低维度——Env：机位、观察朝向、前景/中景/背景、光照、材质/空间、去人物化。Character：固定机位、全身含鞋、四格顺序、稳定锚点、服装一致、浅灰底。Prop：固定机位、结构视角序列、材质锚点、柔和静物光、单状态、浅灰底。
