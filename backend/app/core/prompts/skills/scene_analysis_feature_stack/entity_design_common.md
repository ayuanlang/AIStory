...
| **Environment / Poster** | 光学 rationale + 主辅色谱 + FG/MG/BG 各层受光与投影 | 须写 **≥2 动机光源**；**每个光源须写作用范围（覆盖哪一层/哪片具名表面/未照亮暗区）+ 可见效果（投影落点/条纹光/反射/高光/体积光等）** + 亮区/暗区色谱 + Key:Fill 关系；主环境两宫格须与 §B 主色/辅色/过渡色一致 |
...
4. 是否与同项目其他 Subject 主色谱冲突或回退均匀平光？
