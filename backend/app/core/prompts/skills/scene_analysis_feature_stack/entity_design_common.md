...
- **Character `clothing`**：匹配项目语言语境、身份、时代；含定位、版型/材质/配色、可复用风格词。**服饰对标**见 character §1.2A：当代都市/职场/晚宴走经典时装；**古装/武侠/仙侠/军人/将领/异兽走经典影视剧与游戏**（禁时装/runway/高定古风写真）。将领另须威武钢铁化。**服色散**见 character §1.2A：主色锁身份制度，须有辅色与点缀，总色数 3–7，色数按年龄/身份/性格定档。**群演簇不豁免本条**——簇共性**衣本体**须写满与单人同等槽（`clothing` ≥7，款式/版型/材质/配色/鞋履；**个数不含附属物**）；配饰/器械/旗帜/坐骑另写满槽、不占 ≥7；**禁止**为簇另挂 `PROP:[…]`；军警/仪仗/甲胄另须远读剪影+近读徽识/甲片/靴履/器械（见 character §2.4）。**成人向年轻女性**剪裁关键词（露肩/深V领/开叉/短裙/短裤/短靴/露背）见 character 分型；`clothing_req`/制服/礼制仍优先。
