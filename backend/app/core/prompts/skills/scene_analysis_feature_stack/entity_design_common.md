...
- **Character `clothing`**：匹配项目语言语境、身份、时代；含定位、流行穿搭方向、版型/材质/配色、可复用风格词；无法检索时用通用时尚知识给可信参考。**成人向年轻女性**剪裁关键词（露肩/深V领/开叉/短裙/短裤/短靴/露背）见 character 分型；`clothing_req`/制服/礼制仍优先。
