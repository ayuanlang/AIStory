...
**推荐转译句式（仅 Env/Poster 的 `generation_prompt_cn`；Character 真人定妆禁套用）**：`大光比={Key:Fill}+亮暗分区。主冷暖基调={四选一}。主色/辅色/点缀/过渡={具名色@材质表面}。纵深色层：前景={…}；中景={…}；背景={…}。亮区={…}；暗区={…}。Fill={…}。`
...
| **Environment / Poster** | 光学 rationale + environment §2.9 色彩规格（含纵深色层）+ 主辅点缀实体落点 + 各层受光；夜景 §2.8 | 可见动机光 1–3（上限 3）；每源作用范围+效果；§2.9 全段（主辅点缀过渡+FG/MG/BG 色层+提神点缀）；主环境四向共享色谱秩序且各格有可见表面色落点；禁单色/灰褐糊 |
...
6. **Env 美观不单调**：主+辅可辨、≥1 提神点缀、FG/MG/BG 纵深色层已写、无灰褐单色糊？
