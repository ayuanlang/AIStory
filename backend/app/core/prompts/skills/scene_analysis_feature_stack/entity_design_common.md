...
| **Environment / Poster** | 光学 rationale + 主辅色谱 + FG/MG/BG 各层受光与投影 | 须写 **≥2 动机光源** + 亮区/暗区色谱 + Key:Fill 关系；主环境两宫格须与 §B 主色/辅色/过渡色一致 |
...
3. `generation_prompt_cn` 能否回答：**哪一区暖、哪一区冷、哪一层亮、哪一层暗、光从哪来**？
