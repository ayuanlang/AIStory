...
- **服装**：`clothing` 首句固定「播出安全等级：成人|非成人。」；服饰的设计要符合朝代，地域，人物身份地位的特征；**必须检索并写出符合该朝代/地域的具体款式、纹理、材质等细节，不能仅泛泛说是或写成“某某朝代的服饰”**；须含 1 组潮流/风格关键词 + 版型/材质/配色/鞋履可见落点，并回写进 `generation_prompt_cn`。
