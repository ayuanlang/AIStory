...
- **全局色彩谱系约束（新增强制）**：所有实体的色彩描述不能只停留在“暖色”“冷色”“高饱和”“低饱和”这种单层判断，必须尽量建立可执行的色彩谱系。默认至少交代以下三层：1) 画面的基础主色基底，用于定义项目或空间的大面积综合色倾向；2) 中间过渡色，用于连接主光区、半影区、背景退层与材质之间的色彩缓冲；3) 小面积强调色或亮点色，用于提神、聚焦和制造节奏。若题材并未要求极端极简或单色压迫风格，禁止把整张图写成只有单一综合色覆盖的单调画面；必须让色彩在区域、材质、距离和光源之间产生层级递进。
...
- **色彩组织与层级控制规则（新增强制）**：环境色彩必须避免“整屋一个颜色”或“单纯套滤镜”的贫乏写法。需要根据题材与空间功能，主动规划基础主色、辅助过渡色、次级区域色和强调色，并让它们通过墙面、织物、木石金属、灯具、窗光、反射面、雾层、水面或远景气氛自然分布。默认应先建立 `2-3` 个主导色系作为大结构骨架，但**不等于整张画面只能剩下 `2-3` 个颜色**；在主次秩序明确的前提下，允许围绕主导色系继续展开更丰富的中间色、邻近色、反射色和区域性色带。至少要尽量区分：1) 占比最大的基础主色；2) 与主色形成冷暖、明暗或材质平衡的第二主色；3) 负责空间过渡、材质转译或空气层退变的次级色层；4) 用于聚焦或题材识别的强调色。除上游明确要求极简、压抑、宗教肃穆、工业单色、雾中失真、停电应急等近单色控制场景外，禁止把整张画面写成单一色相家族内部的机械深浅变化，也不要把“强调色”误写成只能零星点缀的孤立亮点。
...
- **仙侠色彩特设规则（新增强制）**：若题材属于仙侠、东方幻想、神话传奇或修真奇观，色彩不应只被理解为现实空间照明下的自然综合色，还应承担灵气属性、法力层级、宗门气质、天地异象与神性秩序的表达功能。优先使用更具超现实诗性的色彩组合，例如月白与青碧、黛青与玉绿、玄黑与鎏金、苍蓝与灵银、雾紫与冷金等；这些颜色可以来自天光、云海反射、法阵辉光、法器流光、符箓燃光、灵泉雾气、神木微光或护山结界，而不必被日常现实室内外照明逻辑完全限制。仙侠环境仍应有主导色系与主次比例平衡，但**不应被僵硬压缩成只有两三种颜色加一点点亮色**；允许围绕主色继续展开更丰富的灵气过渡色、雾中混色、玉石反射色、结界流动色、天象异光色和材质折返色，让色彩在殿宇、山体、云海、雾层、法阵、灵泉、神木与远空之间形成更华丽但有秩序的层层递进。若需要增强仙侠的灵动感与贵气，也允许引入更明亮、更成体系的流动色带或区域性色层，如朱砂灵纹、明青霞气、电蓝结界边缘、晶莹翠绿灵泉反照、暖金瑞光云缝，但必须明确其来自何种法力源、自然异观或材质反射，并说明它们如何分布在空间不同层级中。关键在于色彩要服务“仙气、灵性、威仪、宿命、神性尺度”的叙事，而不是退回普通古风写实用色。
