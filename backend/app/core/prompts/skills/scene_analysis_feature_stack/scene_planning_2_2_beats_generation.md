...
# Prompt Updated At: 2026-06-28 23:15:00 +08:00
...
Beat 数/顺序 = Stage 1｜`Episode ID`/`Scene ID`/`Scene No.` 规范且与 Stage 1 场序一致｜**Stage 1 说明性字段全集已逐条落入 Core Scene Info、无省略写法**｜语义 = Stage 1（仅实体 Index 化）｜衍生选用与 Stage 1 观察/状态一致｜全部 CHAR/ENV/PROP = Index 逐字一致｜时长已复核｜缺口已标 `{覆盖核销}`。
...
| `{主环境}` | 继承 Stage 1【主环境】**全文**（含 360° 拓扑等）；环境实体名 Index 化 |
