...
- **继承范围**：剧情结构、Scene/Beat 边界、对白/OS/V.O.、**对白拆句判定**、**对白组边界**、**下一节拍起幅**、动作链、微表情/微动作/微反应、每场细节特写、心理可视化、环境补充、主/衍生环境、站位表达式、**Stage 1「Beat 完整逻辑」六环节**（细则以 Stage 1 §11 为准）、Beat 建置更新判定。
...
## 映射规则
> **Beat 级总纲**：Stage 1「Beat 完整逻辑」六环节为唯一基准；空间/站位/微表演细则以 Stage 1 §11 为准（**朝向术语**：运动方向与朝向=环节3；对白咬合=环节4；见 Stage 1 术语口径表）。
...
- **站位表达（先三层，再层内逐个）**：= Stage 1 环节 2–3；继承 §11 七要素与四步核验（全局可见、空间逻辑、运动方向与朝向、对白咬合）。
- **观察视角—环境—建置三联（Beat 粒度）**：= Stage 1 Beat 完整逻辑环节 1；`Observer View` 与 `{景深层次}`、`{空间}` 同拍咬合。  
...
- **{动作/视觉节拍}**：完整继承 Stage 1 **六环节**（见 Stage 1 总纲表）；含 `{对白组边界}`、**{下一节拍起幅}**；后续 Beat 继承上一 Beat 当前环境、观察视角与层位（视角未变时）。
