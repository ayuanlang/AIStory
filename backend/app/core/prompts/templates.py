...
Prompt quality constraints (Imagen-compatible): write fluent natural English; avoid engine-specific parameters/tokens (`--ar`, `--stylize`, `::`, `<lora:...>`); keep instructions non-contradictory; prioritize concrete visual details over abstract buzzwords.
...
Prompt quality constraints (Imagen-compatible): use natural English sentence flow, avoid model-specific flags/tokens, avoid contradictory material/lighting directives, and keep one clear primary subject.
"""
...
Prompt quality constraints (Imagen-compatible): keep natural-language phrasing, stable scene geometry, and conflict-free lighting instructions; avoid engine-specific parameter syntax and placeholder leftovers.
"""
