...
def _build_optimize_user_prompt(*, draft_markdown: str, scene_context: str = "") -> str:
    ...
    return (
        ...
        "P1 writes that beat's 【建置】 then 背景参考图为 ENV:; same-ENV later Pn skip full placement; "
        "ENV-name change Pn includes that beat's 【建置】; 全局动态风格 after the two lighting sections; "
