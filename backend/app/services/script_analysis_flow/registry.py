...
def _base_node_specs() -> List[Dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "auto_start": True,
            "fan_out": ["environment_plan", "scene_subskill_pipeline"],
        ...
        },
        {
            ...
            "injection_chain": [
                ...
                "backend.analyze_scene.project_metadata",
                "backend.analyze_scene.reuse_subject_assets",
                "backend.programmatic_scene_split_plus_per_scene_env",
            ],
            "auto_start": True,
            # Starts as soon as environment_plan finishes (main-env splice).
            # Does not wait for scene_subskill_pipeline; derived envs are ingested from framing.
            "fan_out": ["asset_design_character", "asset_design_prop", "asset_design_environment"],
            "fan_out_mode": "parallel_after_complete",
            "status": "planned",
        },
        {
            ...
            "depends_on": ["scene_subskill_pipeline", "assets_extraction"],
