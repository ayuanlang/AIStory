...
def _base_node_specs() -> List[Dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "auto_start": True,
            "fan_out": ["environment_plan", "scene_subskill_pipeline", "asset_design_character", "asset_design_prop"],
        ...
        },
        {
            ...
            "persist_targets": ["programmatic_merge.scene_by_id", "episode.ai_scene_analysis_adaptation", "episode.ai_stage_outputs.stage1.environment_plan"],
            "injection_chain": [
                "frontend.stage1_project_context",
                "backend.analyze_scene.project_metadata",
                "backend.analyze_scene.project_main_environments",
            ...
            "auto_start": True,
            "fan_out": ["asset_design_environment"],
            "fan_out_mode": "parallel_after_complete",
            "status": "routable_existing_executor",
        },
        {
            ...
            "persist_targets": [
                "episode.ai_scene_analysis_adaptation",
                "episode.ai_stage_outputs.stage1.scene_subskills",
                "episode.entities.environment.derived_after_framing",
                "episode.ai_stage_outputs.stage1.derived_environment_jsons",
                "scene_rows",
            ],
            "injection_chain": [
                "backend.programmatic_scene_split",
                "backend.comprehensive_info",
                "backend.special_scene_routing",
            ...
            "auto_start": True,
            "fan_out": "per_scene",
            "executor": "scene_subskill_pipeline.per_scene",
            "status": "routable_existing_executor",
        },
        {
            ...
            "phase": 2,
            "title": "整集资产清单抽取（已退役）",
            "prompt_file": "skills/scene_analysis_feature_stack/_archive/2026-09-05-retired/scene_planning_2_1_assets_extraction.md",
            "depends_on": [],
            "outputs": [],
            "persist_targets": [],
            "injection_chain": [],
        ...
        },
        {
            "key": "scene_markdown",
            "phase": 2,
            "title": "场景编排 Markdown（已退役）",
            "prompt_file": "skills/scene_analysis_feature_stack/_archive/2026-09-05-retired/scene_planning_2_2_beats_generation.md",
            "depends_on": [],
            "outputs": [],
            "persist_targets": [],
            "injection_chain": [],
        ...
        },
        {
            ...
            "injection_chain": ["frontend.entity_design_common_prompt", "frontend.asset_design_project_context", "backend.scene_split_char_brief", "backend.analyze_scene.project_metadata"],
            "auto_start": True,
            "fan_out": None,
            "status": "planned",
        },
        {
            ...
            "injection_chain": ["frontend.entity_design_common_prompt", "frontend.asset_design_project_context", "backend.scene_split_prop_brief", "backend.analyze_scene.project_metadata"],
            "auto_start": True,
            "fan_out": None,
            "status": "planned",
        },
