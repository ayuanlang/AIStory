...
def _base_node_specs() -> List[Dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "auto_start": True,
            "fan_out": ["environment_plan"],
            "fan_out_mode": "sequential_after_complete",
        ...
        },
        {
            ...
            "auto_start": True,
            "fan_out": ["assets_extraction", "scene_subskill_pipeline"],
        ...
        },
        {
            ...
            "persist_targets": ["episode.ai_scene_analysis_adaptation", "episode.ai_stage_outputs.stage1.scene_subskills"],
            "injection_chain": ["backend.programmatic_scene_split", "backend.comprehensive_info", "backend.special_scene_routing"],
            "auto_start": True,
            "fan_out": "per_scene",
