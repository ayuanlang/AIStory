...
def init_system_api_settings(db):
    ...
    kie_models = [
        ...
        _kie_item("Kie Suno", "Audio", "suno"),
        _kie_item("Kie Runway Gen3 Alpha", "Video", "runwayml/gen3a-turbo"),
        _kie_item("Kie Runway Gen3 Alpha Image to Video", "Video", "runwayml/gen3a-turbo-image-to-video"),
        _kie_item("Kie 4o Image", "Image", "gpt4o-image"),
        _kie_item("Kie Flux Kontext", "Image", "flux/kontext"),
