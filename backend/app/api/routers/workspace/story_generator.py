...
async def generate_project_story_dna_global(
    ...
    title_policy_block = (
        ...
        "- You MUST coin an artistic, euphonic, poster-ready script title that fits this story's theme, core image, and tone.\n"
        "- The title must sound like a real film/drama name (e.g. 暗潮工牌 / 隐秘的角落), NOT a plot synopsis, genre label, or project codename.\n"
        "- Prefer 2–6 Chinese characters (or 1–5 English words if Language is English); readable aloud; metaphorical, not spoiler-y.\n"
        "- In THINKING, list 2–3 candidates and pick one with #片名理据:意象=…｜剧情锚=…｜好听=…｜不泄=…\n"
        "- In §0, keep the same #片名理据 tag after Script Title.\n"
        ...
        "- Forbidden: Type/genre suffixes (悬疑/言情/穿越记), production-format words (实拍/真人剧/Live Action), "
        "generic padding (纪事/传奇/风云/之战/物语), 角色名+的故事, ending/villain spoilers.\n"
