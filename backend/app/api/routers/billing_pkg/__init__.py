# -*- coding: utf-8 -*-
"""Billing / recharge / credits routers package."""
from __future__ import annotations

from app.api.routers.billing_pkg.shared import router
from app.api.routers.billing_pkg import shared as _shared

from app.api.routers.billing_pkg import management as _management  # noqa: F401,E402

_SECTION_MODULES = (_management,)
