# -*- coding: utf-8 -*-
"""Assets CRUD / analyze routers package."""
from __future__ import annotations

from app.api.routers.assets_pkg.shared import router
from app.api.routers.assets_pkg import shared as _shared

from app.api.routers.assets_pkg import analyze as _analyze  # noqa: F401,E402

_SECTION_MODULES = (_analyze,)
