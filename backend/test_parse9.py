...
print('callback extract url on eventData:', _extract_job_result_url(payload.get('eventData', {})))
print('compact job result url on eventData:', _extract_job_result_url(_compact_job_result(payload.get('eventData', {}))))
